...
IMPORTANT    
    ...
    - To use the provided ae_util.c functions, AE_ENABLE needs to be defined. The starter code has AE_ENABLE disabled for now.
      more public testing suites that use the ae_util.c functions will be released one week before the project is due. 
